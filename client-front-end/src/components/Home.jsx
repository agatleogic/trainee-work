...
const Home = () => {
  ...
  return (
    <div className="container my-5 py-5" style={{ backgroundColor: "lightgrey" }}>
      <div className="border rounded-3 m-auto text-center" style={{ width: "500px", backgroundColor: "white" }}>
        <div className="my-4">
          <h1 className='App'>Home page</h1>
        </div>
        <div className="my-3">
          <Input type='text' name='title' placeholder='enter title' value={category} onChange={(e) => setCategory(e.target.value)} />
        </div>
        <div className="my-3">
          <input type='file' name='photo' onChange={(e) => setImage(e.target.files)} multiple />
        </div>
        <div className="my-3">
